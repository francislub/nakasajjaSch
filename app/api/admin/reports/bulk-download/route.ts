...
function generateBulkReportCardsHTML(reportCards: any[], gradingSystem: any[]) {
...
<body>
    <div class="summary-info no-print">
        <strong>Bulk Report Cards</strong><br>
        Total: ${reportCards.length} students<br>
        Generated: ${new Date().toLocaleDateString()}
    </div>
    
    <button class="print-button no-print" onclick="window.print()">Print All Report Cards</button>
