export interface ReportCardData {
  ...
  export function generateReportCardHTML(data: ReportCardData): string {
    ...
    // Generate subject rows for all subjects
    const subjectRows = allSubjectsData
      .map((subject: any) => {
        ...
        return `
        <tr>
          <td style="text-align: left; padding: 4px; font-size: 14px; font-weight: bold;">${subject.name.toUpperCase()}</td>
          <td style="font-size: 14px; font-weight: bold;">100</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.homework || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.bot || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.botGrade || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.midterm || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.midtermGrade || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.eot || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.eotGrade || ""}</td>
          <td style="text-align: left; padding: 4px; font-size: 14px; font-weight: bold;">${subject.remarks || ""}</td>
          <td style="font-size: 14px; font-weight: bold;">${subject.teacherInitials || ""}</td>
        </tr>
      `
      })
      .join("")
    ...
    const totalHomework = allSubjectsData.reduce((sum, s) => sum + (Number(s.homework) || 0), 0)
  ...
  <head>
      ...
      <style>
          ...
          .assessment-table th:nth-child(1) { width: 15%; }
          .assessment-table th:nth-child(2) { width: 8%; }
          .assessment-table th:nth-child(3) { width: 7%; }
          .assessment-table th:nth-child(4) { width: 7%; }
          .assessment-table th:nth-child(5) { width: 6%; }
          .assessment-table th:nth-child(6) { width: 8%; }
          .assessment-table th:nth-child(7) { width: 6%; }
          .assessment-table th:nth-child(8) { width: 7%; }
          .assessment-table th:nth-child(9) { width: 6%; }
          .assessment-table th:nth-child(10) { width: 20%; }
          .assessment-table th:nth-child(11) { width: 10%; }
          ...
          <div class="main-content">
                  ...
                  <table class="assessment-table">
                      ...
                      <tbody>
                          ...
                          <tr style="background-color: #f0f0f0;">
                              ...
                              <td style="font-size: 14px; font-weight: bold;">${allSubjectsData.length * 100}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totalHomework || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totalBot || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totals?.botAggregates < 4 ? "X" : totals?.botAggregates || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totalMidterm || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totals?.midtermAggregates < 4 ? "X" : totals?.midtermAggregates || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totalEot || ""}</td>
                              <td style="font-size: 14px; font-weight: bold;">${totals?.eotAggregates < 4 ? "X" : totals?.eotAggregates || ""}</td>
                              <td></td>
                              <td></td>
                          </tr>
                      </tbody>
              ...
              <div class="personal-assessment">
                  ...
                  <div class="personal-assessment-key">
                      A-VERY GOOD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; B-GOOD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C-FAIR &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; D-NEEDS IMPROVEMENT
                  </div>
              </div>
          </div>
